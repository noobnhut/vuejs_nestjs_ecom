  ...
  <section class="py-2">
    <div class="max-w-5xl mx-auto py-16 bg-white">
      <article class="overflow-hidden">
        <div
          class="bg-[url(https://mixivivu.com/section-background.png)] bg-cover bg-center bg-no-repeat rounded-b-md"
        >
          <div class="p-9">
            <div class="space-y-6 text-slate-700">
              ...
              <hr
                class="h-1 mx-auto my-4 bg-gray-300 border-0 rounded md:my-10"
              />
              <p
            ...
            <div class="flex w-full">
              <div class="sm:grid grid-cols-4 gap-12 block">
                ...
                <div class="text-sm font-light text-slate-500">
                  ...
                  <p>{{ formatDate(this.order.created_at) }}</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <table class="min-w-full divide-y divide-slate-500">
                ...
                <tfoot>
                  <tr>
                    ...
                    >
                      {{ formatPrice(this.order.total_bank) }}
                    </td>
                  </tr>
                </tfoot>
              </table>
          ...
          <div id="confirmation-bt" class="w-full">
            <button class="rounded-lg mb-5 p-3 px-6 w-full" @click="goHome()">
              Về trang chủ
            </button>
          </div>
